...
//     }
// }
// void update(int node, int l, int r, int indx, int val, int x)
// {
...
//         update(leftNode, l, mid, indx,val,x);
//         update(rightNode, mid + 1, r, indx,val,x);
//         tree[node] = tree[leftNode] + tree[rightNode];
//     }
// }
// int main()
