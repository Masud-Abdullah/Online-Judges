...
int main()
{
    ...
    while (t--)
    {
        ...
        if(x==y)cout<<y+(r%a)<<nl;
        else
        {
            int p=y+(r%a);
            int q= ((r/a)-1)+(a-1); // ekhane a-1 howar karon 'a' diye je number kei mod kori na ken result always 1 theke a-1 er moddhei thakbe,ar maximun value hobe a-1. 
